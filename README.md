...
| `+` | `+` |
| [debian-iso-builder-remix-spectrwm](https://samwhelp.github.io/debian-iso-builder-remix-spectrwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-spectrwm) |
| `=` | `=` |
| [debian-iso-builder-respin-spectrwm](https://samwhelp.github.io/debian-iso-builder-respin-spectrwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-spectrwm](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-spectrwm.git
```


> change dir to `debian-iso-builder-respin-spectrwm`

``` sh
cd debian-iso-builder-respin-spectrwm
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-spectrwm/dist`
